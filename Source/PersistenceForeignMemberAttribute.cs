...
namespace GDA
{
	...
	public class PersistenceForeignMemberAttribute : Attribute
	{
		/// <summary>
		...
		public PersistenceForeignMemberAttribute(Type typeOfClassRelated, string propertyName, int numberGroupOfRelationship) : this(typeOfClassRelated, propertyName, numberGroupOfRelationship.ToString())
		{
		}
		...
		public PersistenceForeignMemberAttribute(Type typeOfClassRelated, string propertyName, string groupOfRelationship)
		{
		...
		/// <param name="typeOfClassRelated">Classe na qual será feito o relacionamento.</param>
		/// <param name="propertyName">Nome da propriedade que será relacionada.</param>
		public PersistenceForeignMemberAttribute(Type typeOfClassRelated, string propertyName) : this(typeOfClassRelated, propertyName, null)
		{
		}
	}
}
