...
namespace GDA
{
	...
	public class PersistenceForeignMemberAttribute : Attribute
	{
		...
		public PersistenceForeignMemberAttribute (Type a, string b, int c) : this (a, b, c.ToString ())
		{
		}
		public PersistenceForeignMemberAttribute (Type a, string b, string c)
		{
			_typeOfClassRelated = a;
			_propertyName = b;
			_groupOfRelationship = c;
		}
		public PersistenceForeignMemberAttribute (Type a, string b) : this (a, b, null)
		{
		}
	}
}
