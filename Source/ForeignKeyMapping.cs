...
namespace GDA.Mapping
{
	...
	public class ForeignKeyMapping : ForeignItemMapping
	{
		...
		public ForeignKeyMapping(XmlElement element, string mappingNamespace, string mappingAssembly) : base(element, mappingNamespace, mappingAssembly)
		{
		}
		...
		public ForeignKeyMapping(TypeInfo typeOfClassRelated, string propertyName, string groupOfRelationship) : base(typeOfClassRelated, propertyName, groupOfRelationship)
		{
		}
